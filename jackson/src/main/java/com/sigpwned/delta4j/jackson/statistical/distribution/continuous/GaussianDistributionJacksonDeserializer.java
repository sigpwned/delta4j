...
public class GaussianDistributionJacksonDeserializer extends
    StdDeserializer<GaussianDistribution> {

  public static final GaussianDistributionJacksonDeserializer INSTANCE = new GaussianDistributionJacksonDeserializer();

  public GaussianDistributionJacksonDeserializer() {
